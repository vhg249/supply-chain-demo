...
const mnemonic = "museum mosquito add chicken despair various motor final birth great jealous head";
...
module.exports = {
  ...
  networks: {
    ...
    development: {
      ...
      gas: 5000000, // Use `gas` & `gasPrice` only if creating type 0 transactions
